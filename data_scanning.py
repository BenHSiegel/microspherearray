...
pixtoum = 11/12  #diameter of sphere (um) / number of pixels for diameter of sphere
centroid_diameter = 15 #centroid size to look for in the images in pixels, always odd and overestimating size
rowlen = 1
pcacheck = False
saveposdata = True
saveFFTavg = True
